double calc_rel_width(const double* x){
    ...
    auto ch2_hist=new_df.Histo1D({"ch2_charge","Channel 2",100,1500,4000},"ch2_charge"); //25 fC bins
...
void gain_calib_strat2_gain2(std::string filename="EMPP_100Gev_e_charge_pos_upd2",int filter_num_of_peaks=1){
