double calc_rel_width(const double* x){
    ...
    auto ch1_hist=new_df.Histo1D({"ch1_charge","Channel 1",100,1500,4000},"ch1_charge");
...
void gain_calib_strat2_gain1(std::string filename="EMPP_100Gev_e_charge_pos_upd2",int filter_num_of_peaks=1){
