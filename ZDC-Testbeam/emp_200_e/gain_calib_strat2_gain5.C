double calc_rel_width(const double* x){
    ...
    auto ch5_hist=new_df.Histo1D({"ch5_charge","Channel 5",140,3000,6500},"ch5_charge");
...
void gain_calib_strat2_gain5(std::string filename="EMPP_200Gev_e_charge_pos_upd2",int filter_num_of_peaks=1){
