void plot_each_charge_hist(std::string filename, int filter_num_of_peaks=1,double rel_gain1=1,double rel_gain2=1,double rel_gain4=1,double rel_gain5=1){
    ...
    auto ch1_hist=new_df.Define("ch1_plot",ch1_plot,{"charge1"}).Histo1D({"ch1","Channel 1",260,1000,7500},"ch1_plot");
    auto ch2_hist=new_df.Define("ch2_plot",ch2_plot,{"charge2"}).Histo1D({"ch2","Channel 2",260,1000,7500},"ch2_plot");
    auto ch3_hist=new_df.Histo1D({"ch3","Channel 3",260,1000,7500},"charge3");
    auto ch4_hist=new_df.Define("ch4_plot",ch4_plot,{"charge4"}).Histo1D({"ch4","Channel 4",260,1000,7500},"ch4_plot");
    auto ch5_hist=new_df.Define("ch5_plot",ch5_plot,{"charge5"}).Histo1D({"ch5","Channel 5",260,1000,7500},"ch5_plot");
