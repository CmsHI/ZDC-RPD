double calc_rel_width(const double* x){
    ...
    auto ch2_hist=new_df.Histo1D({"ch2_charge","Channel 2",180,2500,7000},"ch2_charge"); //25 fC bins
...
void gain_calib_strat2_gain2(std::string filename="EMM_150Gev_e_charge_pos_upd2emm",int filter_num_of_peaks=1){
