double calc_rel_width(const double* x){
    ...
    auto ch5_hist=new_df.Histo1D({"ch5_charge","Channel 5",180,2500,7000},"ch5_charge");
...
void gain_calib_strat2_gain5(std::string filename="EMM_150Gev_e_charge_pos_upd2emm",int filter_num_of_peaks=1){
