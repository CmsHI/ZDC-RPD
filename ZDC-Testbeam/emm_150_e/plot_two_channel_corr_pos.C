void plot_two_channel_corr_pos(std::string filename="default",int filter_num_of_peaks=1,double xmin=-63,double xmax=89.5,double gain1=1,double gain2=1., double gain4=1,double gain5=1){
    ROOT::RDataFrame charge_df("main_tree",(filename+".root"));
    double ch_pos_arr[5]={-9.842,6.461,21.38,36.73,51.89};
    ...
    int num_of_pos= (xmax-xmin)/2.5+1;
