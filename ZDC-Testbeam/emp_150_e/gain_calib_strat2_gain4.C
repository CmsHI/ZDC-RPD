double calc_rel_width(const double* x){
    ...
    auto ch4_hist=new_df.Histo1D({"ch4_charge","Channel 4",140,2000,5500},"ch4_charge");
...
void gain_calib_strat2_gain4(std::string filename="EMPP_150Gev_e_charge_pos_upd2",int filter_num_of_peaks=1){
