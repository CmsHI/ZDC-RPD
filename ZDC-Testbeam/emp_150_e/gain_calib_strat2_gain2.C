double calc_rel_width(const double* x){
    ...
    auto ch2_hist=new_df.Histo1D({"ch2_charge","Channel 2",140,2000,5500},"ch2_charge"); //25 fC bins
...
void gain_calib_strat2_gain2(std::string filename="EMPP_150Gev_e_charge_pos_upd2",int filter_num_of_peaks=1){
