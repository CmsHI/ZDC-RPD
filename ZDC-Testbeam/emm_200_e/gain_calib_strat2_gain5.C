double calc_rel_width(const double* x){
    ...
    auto ch5_hist=new_df.Histo1D({"ch5_charge","Channel 5",200,3500,8500},"ch5_charge");
...
void gain_calib_strat2_gain5(std::string filename="EMM_200Gev_e_charge_pos_upd2emm",int filter_num_of_peaks=1){
    ...
    double step[1] = {0.0005};
    // starting point

    double variable[1] = { 1.25};
