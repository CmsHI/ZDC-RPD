double calc_rel_width(const double* x){
    ROOT::RDataFrame charge_df("main_tree",("EMM_200Gev_e_charge_pos_upd2emm.root"));
    ...
    auto ch4_hist=new_df.Histo1D({"ch4_charge","Channel 4",200,3500,8500},"ch4_charge");
    auto ch3_hist=new_df.Histo1D({"ch3","Channel 3",200,3500,8500},"charge3");
...
void gain_calib_strat2_gain4(std::string filename="EMM_200Gev_e_charge_pos_upd2emm",int filter_num_of_peaks=1){
