double calc_rel_width(const double* x){
    ...
    auto ch1_hist=new_df.Histo1D({"ch1_charge","Channel 1",120,2000,5000},"ch1_charge");
...
void gain_calib_strat2_gain1(std::string filename="EMM_100Gev_e_charge_pos_upd2emm",int filter_num_of_peaks=1){
