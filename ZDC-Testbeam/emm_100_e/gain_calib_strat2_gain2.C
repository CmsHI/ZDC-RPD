double calc_rel_width(const double* x){
    ROOT::RDataFrame charge_df("main_tree",("EMM_100Gev_e_charge_pos_upd2emm.root"));
    ...
    auto ch2_hist=new_df.Histo1D({"ch2_charge","Channel 2",120,2000,5000},"ch2_charge"); //25 fC bins
...
void gain_calib_strat2_gain2(std::string filename="EMM_100Gev_e_charge_pos_upd2emm",int filter_num_of_peaks=1){
